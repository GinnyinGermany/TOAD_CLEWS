...
field = np.loadtxt("results/droughts/unstable_amaz_{}_{}_decade{}_adaptsample{}_field.txt".format(resolution_type, scenario_type, decade, str(start_file).zfill(3)))
...
np.savetxt("results/droughts_tipping_reason/rain_diff_{}_{}_adaptsample{}_rainfact{}_decade{}_field.txt".format(resolution_type, 
    scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), diff_rain)
np.savetxt("results/droughts_tipping_reason/mcwd_diff_{}_{}_adaptsample{}_rainfact{}_decade{}_field.txt".format(resolution_type, 
    scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), diff_mcwd)
...
plt.savefig("results/droughts_tipping_reason/rain_diff_{}_{}_adaptsample{}_rainfact{}_decade{}.png".format(resolution_type, 
    scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), bbox_inches='tight')
plt.savefig("results/droughts_tipping_reason/rain_diff_{}_{}_adaptsample{}_rainfact{}_decade{}.pdf".format(resolution_type, 
    scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), bbox_inches='tight')
#plt.show()
plt.clf()
plt.close()
...
plt.savefig("results/droughts_tipping_reason/mcwd_diff_{}_{}_adaptsample{}_rainfact{}_decade{}.png".format(resolution_type, 
        scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), bbox_inches='tight')
plt.savefig("results/droughts_tipping_reason/mcwd_diff_{}_{}_adaptsample{}_rainfact{}_decade{}.pdf".format(resolution_type, 
        scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), bbox_inches='tight')
#plt.show()
plt.clf()
plt.close()
...
np.savetxt("results/droughts_tipping_reason/complete_discrete_diff_{}_{}_adaptsample{}_rainfact{}_decade{}_field.txt".format(resolution_type, 
        scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), complete_discrete)
...
plt.savefig("results/droughts_tipping_reason/complete_discrete_diff_{}_{}_adaptsample{}_rainfact{}_decade{}.png".format(resolution_type, 
        scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), bbox_inches='tight')
plt.savefig("results/droughts_tipping_reason/complete_discrete_diff_{}_{}_adaptsample{}_rainfact{}_decade{}.pdf".format(resolution_type, 
        scenario_type, str(start_file).zfill(3), int(np.around(100*rain_fact)), decade), bbox_inches='tight')
#plt.show()
plt.clf()
plt.close()
